...
categories: ['Uncategorized', 'Business', 'Electronics', 'Low Power Design Series' ]
...
<p><img class="alignright" src="/assets/images/posts/image_1.webp" alt="This image has an empty alt attribute; its file name is image.png" width="166" height="167" /><span style="font-size: inherit;">Linear regulators may appear to be a low cost and cheap solution at first glance but are flawed by their inherent design. They act as a variable resistor at their base, wasting excess power in the form of heat. For an application that saves every microwatt of power, they are not a good selection for low power design. </span></p>
