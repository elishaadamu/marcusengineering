                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                {% for category in categories %}
                                    {% assign cat_url = '/category/' | append: category[0] | append: '/' %}
                                    ...
                                    <div class="blog-list-item">
                                        ...
                                        <div class="blog-list-content">
                                            ...
                                            <div class="blog-list-meta">
                                                ...
                                                {% endfor %}
                                                {% assign cat_url = '/category/' | append: category[0] | append: '/' %}
                                                <a href="{{ cat_url | relative_url }}" class="ml-auto text-[10px] font-black text-brand uppercase tracking-widest hover:underline">View All {{ category[0] }}</a>
                                            </div>
                                        </div>
                                    </div>
                                {% endfor %}
